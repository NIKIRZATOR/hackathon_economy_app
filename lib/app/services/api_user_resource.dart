...
class ApiUserResource {
  ...
  static const _resBase = '/user-resource';
  static const _byUserBase = '/user-resource/by-user';

  // GET /user-resource/by-user/:idUser
  Future<List<UserResource>> getByUser(int userId) async {
    final r = await _dio.get('$_byUserBase/$userId');
