class BuildingType {
  ...
  factory BuildingType.fromJson(Map<String, dynamic> json) => BuildingType(
    idBuildingType: json['idBuildingType'] ?? 0,
    titleBuildingType: json['titleBuildingType'] ?? '',
    description: json['description'],
    cost: json['cost'] ?? 0,
    hSize: json['hSize'] ?? 1,
    wSize: json['wSize'] ?? 1,
    unlockLevel: json['unlockLevel'] ?? 1,
    maxUpgradeLvl: json['maxUpgradeLvl'] ?? 1,
    imageAsset: json['imagePath'], // сервер присылает imagePath
  );


  Map<String, dynamic> toJson() => {
    'idBuildingType': idBuildingType,
    'titleBuildingType': titleBuildingType,
    'description': description,
    'cost': cost,
    'h_size': hSize,
    'w_size': wSize,
    'unlockLevel': unlockLevel,
    'maxUpgradeLvl': maxUpgradeLvl,
