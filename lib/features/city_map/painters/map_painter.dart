...
class MapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int y = 0; y < rows; y++) {
      for (int x = 0; x < cols; x++) {
        ...
        if (t == 1 && roadTexture != null) {
          ...
          switch (t) {
            case 1: p.color = Colors.black12; break;
            case 2: p.color = const Color(0xFFBDBDBD); break;
            case 3: p.color = const Color(0xFF5DA9E9); break;
            default: continue;
          }
    ...
    if (dragPreview != null) {
      ...
      canvas.drawRect(
        rect,
        Paint()..color = (ok ? Colors.green : Colors.red).withValues(alpha: 0.35),
      );
      canvas.drawRect(
        rect,
        Paint()
